"""Added batch_id in use_composition

Revision ID: 0e10c3d772fa
Revises: f954e23fc3d7
Create Date: 2025-07-08 21:00:14.780205
...
revision: str = '0e10c3d772fa'
down_revision: Union[str, None] = 'f954e23fc3d7'
...
def upgrade() -> None:
    ...
    op.add_column('composition_usage_history', sa.Column('batch_id', sa.Integer(), nullable=False))
...
def downgrade() -> None:
    ...
    op.drop_column('composition_usage_history', 'batch_id')
