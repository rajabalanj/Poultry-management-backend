"""Add notes column to daily_batch table

Revision ID: 2410599ca060
Revises: c337bff8aeba
Create Date: 2025-06-24 21:52:36.507824
...
revision: str = '2410599ca060'
down_revision: Union[str, None] = 'c337bff8aeba'
...
def upgrade() -> None:
    ...
    op.add_column('daily_batch', sa.Column('notes', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('daily_batch', 'notes')
